      ...
      <Modal.Body>
        <div className="mainModalSetup">
          ...
          <div>
            ...
            <div className="p20">
              <span className="question">What is the API key used for?</span>
              <div className="answer">
                An API key is required by the Datadog Api to get the elements of
                your account.
              </div>
            </div>
            <div className="p20">
              ...
              <div className="answer">
                An Application key is required by the Datadog Api. It is used to
            ...
            <div className="p20">
              ...
              <div className="answer">
                The keys will be used to read the data and provide visualization
                of the data that is capturable.
              </div>
            </div>
          </div>
        </div>
